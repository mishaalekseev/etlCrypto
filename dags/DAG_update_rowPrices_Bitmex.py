...
symbols_to_update = ['XBTUSD','ETHUSD','BNBUSD']

with DAG(
    dag_id='DAG_update_rowPrices_Bitmex',
    default_args=args,
    ...
    from func_update_ticker_price_bitmex import update_ticker_price_bitmex

    # Generate 5 sleeping tasks, sleeping from 0.0 to 0.4 seconds respectively
    for ticker in symbols_to_update:
        task = PythonOperator(
            task_id='update_recenttrades_' + str(ticker),
            python_callable=update_ticker_price_bitmex,
